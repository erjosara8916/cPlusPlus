...
![ configuraciones del compilador](img/cofig.jpg "imgen")
    ![ configuracion de loibrerias](img/config2.jpg "imgen")
    ![ configuracion de cabeceras](img/config3.jpg "imgen")

* **Del proyecto**
![ configuracion de cabeceras](img/config4.jpg "imgen")
